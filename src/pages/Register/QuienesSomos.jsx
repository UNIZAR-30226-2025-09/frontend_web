        ...
        <div className="terminos-container">
            <div className="terminos-box">
                ...
                <div className="terminos-text">
                    <p><strong>Vibra</strong> nació con una misión clara: conectar a las personas a través de la música
                    ...
                    <h3>¿Dónde estamos?</h3>
                    <p>Nuestras oficinas están ubicadas en <strong>Calle Creativa 456, Barcelona, España</strong>, pero
